...
<template>
  <div>
    <p ref="text" class="demo-el px-2 rounded" tabindex="0">Paragraph that can be focused</p>
    <input ref="input" class="demo-el" type="text" placeholder="Input that can be focused" />
    <button ref="button" class="demo-el button">Button that can be focused</button>
    <hr />
    <note class="mb-2">
